...
export default defineConfig({
  ...
  redirects: {
    '/blog/6-etapes-pour-developper-une-application-mobile' : '/blog/application-mobile/6-etapes-pour-developper-une-application-mobile',
    '/blog/ameliorez-votre-seo-avec-les-donnees-structurees': '/blog/referencement-naturel/ameliorez-votre-seo-avec-les-donnees-structurees',
    '/blog/automatiser-la-prise-de-rendez-vous-en-ligne' : '/blog/developpement-web/automatiser-la-prise-de-rendez-vous-en-ligne',
    '/blog/cms-headless' : '/blog/developpement-web/cms-headless',
    '/blog/cms-strapi' : '/blog/developpement-web/cms-strapi',
    '/blog/combien-coute-developpement-application-mobile' : '/blog/application-mobile/combien-coute-developpement-application-mobile',
    '/blog/dette-technique-definition-et-impacts' : '/blog/developpement-web/dette-technique-definition-et-impacts',
    '/blog/framework-php-definition-utilite-et-conseils' : '/blog/developpement-web/framework-php-definition-utilite-et-conseils',
    '/blog/framework-sylius' : '/blog/developpement-web/framework-sylius',
    '/blog/les-etapes-cles-de-la-creation-d-un-site-internet': '/blog/developpement-web/les-etapes-cles-de-la-creation-d-un-site-internet',
    '/blog/l-importance-du-sitemap-xml-en-seo' : '/blog/referencement-naturel/l-importance-du-sitemap-xml-en-seo',
    '/blog/pourquoi-et-comment-developper-un-mvp': '/blog/developpement-web/pourquoi-et-comment-developper-un-mvp',
    '/blog/pourquoi-et-comment-faire-la-refonte-de-son-site-web' : '/blog/developpement-web/pourquoi-et-comment-faire-la-refonte-de-son-site-web',
    '/blog/pourquoi-utiliser-le-framework-PHP-laravel' : '/blog/developpement-web/pourquoi-utiliser-le-framework-PHP-laravel',
    '/blog/qu-est-ce-que-le-saas-definition-et-avantages' : '/blog/developpement-web/qu-est-ce-que-le-saas-definition-et-avantages',
